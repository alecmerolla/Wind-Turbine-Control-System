...
volatile int16_t analog = 0, analog_voltage = 0, analog_current = 99; //for ADC reading
...
int main(void)
{
  ...
  while (1) {
    ...
    sendStrings(counters);
    sendStrings(" V= ");
    itoa((int)analog_voltage, counters, 10);
    sendStrings(counters);
    //counter++;
   ...
   // sendStrings(counters);
    ...
    sendStrings(counters);
    sendStrings(" I= ");
    itoa((int)analog_current, counters, 10);
    sendStrings(counters);
